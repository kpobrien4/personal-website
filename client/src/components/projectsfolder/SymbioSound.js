  ...
  render() {
    return (
      <div>
         <div>
            <br></br>
            <h2 class="thin project-title">SymbioSound</h2><a href = "https://github.com/kpobrien4/rails-final-project" target="_blank" rel="noopener noreferrer"><button type="submit" class="thin btn git right links waves-effect waves-light">GitHub</button></a> <a href = "http://symbiosound.herokuapp.com/" target="_blank" rel="noopener noreferrer"><button type="submit" class="thin btn demo right links waves-effect waves-light">Demo</button></a> 
        </div>
        <hr></hr>
